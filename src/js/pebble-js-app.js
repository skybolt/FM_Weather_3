        ...
        if (req.readyState == 4) {
            if (req.status == 200) {
                ...
                if (req.responseText.length > 100) {
                    ...
                    if (debug_flag > 1) {
                        console.log("day3_high = " + day3_high + ", day3_low = " + day3_low + ", day3_temp = " + day3_temp);
                    }
                    ...
                    if (tempFlag != 1 || 6) {
                        ...
                        var day4_temp = day4_high + "/" + day3_low + getTempLabel();
                    }
                    ...
                    if (tempFlag != 1 || 6) {
                        ...
                        var day5_temp = day5_high + "/" + day3_low + getTempLabel();
                    }
